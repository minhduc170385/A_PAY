    ...
    private void DisplayAnswer(String answer)
    {
        ...
        catch (Exception e)
        {
            ...
            if(didItWork)
            {
                ...
                answerChoose = answerChoose.replace(" ","");
                // Log.v("answerChoose" , answerChoose);
                // Log.v("answerChoose" , correctAnswer);
                String tempCorrectAnswer = correctAnswer.replace(" ","");
                tempCorrectAnswer = tempCorrectAnswer.replace("\\n","");
                if(answerChoose.equals(tempCorrectAnswer.trim()))
                {
